        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-3 relative text-sm font-semibold transition-colors ${
              activeTab === 'profile' ? 'text-emerald-600' : 'text-gray-600 hover:text-gray-900'
            }`}
          >
            Profile
            {activeTab === 'profile' && <span className="absolute left-0 right-0 -bottom-px h-0.5 bg-emerald-600" />}
          </button>
          <button
            onClick={() => setActiveTab('security')}
            className={`px-4 py-3 relative text-sm font-semibold transition-colors ${
              activeTab === 'security' ? 'text-emerald-600' : 'text-gray-600 hover:text-gray-900'
            }`}
          >
            Security
            {activeTab === 'security' && <span className="absolute left-0 right-0 -bottom-px h-0.5 bg-emerald-600" />}
          </button>
        </div>
      </div>
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <label className="text-gray-900 text-sm font-semibold">Avatar</label>
              <div className="flex items-center gap-4">
                <div className={`w-14 h-14 ${currentAvatar.bg} rounded-full flex items-center justify-center`}>
                  <span className={currentAvatar.text} style={{ fontSize: '16px', fontWeight: 700 }}>
                    {avatarInitials}
                  </span>
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Avatar upload is simulated in demo mode</span>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-20"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
          ...
          <Card className="p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Two-Factor Authentication</h3>
